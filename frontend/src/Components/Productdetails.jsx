...
export const ProductDetails = () => {
 ...
 <div id="header">
        ...
        <div id="rightSideBox">
            <Link to="/signup"><button style={{width:"100px",marginLeft:"-160px"}}>sign up</button></Link>
            <Link to="/login"><button style={{width:"100px",marginLeft:"80px"}}>log in</button></Link>
            <p>
    ...
    <div id="productDescription">
       ...
       <button onClick={()=>{
        ...
        style={{marginTop:"60%",
        marginLeft:"20%",fontSize:"220%", zindex:"4",width:"100px",
        height:"50px"}}><FaArrowRight/></button>
       <button onClick={()=>{
         if(imgnum>0){
          setimgnum(imgnum-1)
         }
        ...
        style={{marginTop:"60%",
        marginLeft:"-88%",fontSize:"220%",width:"100px",
         zindex:"4",
         height:"50px"
         }}><FaArrowLeft/></button>
        </div>
        ...
        <p>Avilable sizes</p>
          ...
          <Link to="/cart"><button className="add">Add TO BAG</button><br/><br/><br/></Link> 
