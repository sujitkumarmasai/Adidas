...
function Payment() {
    return (
      ...
      <div className='Top'>
         ...
         <p className='pp1'>You may be directed to your bank's 3D secure process to authenticate your information.</p>
         </div>
         <form>
           <input id='input1' type="number" placeholder='Card Number *'/><br/>
           <input id='input1' type="text" placeholder='Name On Card *'/><br/>
         ...
         <button className='button111'> <a className='img111' id='zoom' href='https://www.delaneystudios.com.au/uploads/1/1/8/3/118392473/payment-successful_orig.png'>PLACE ORDER</a></button>
